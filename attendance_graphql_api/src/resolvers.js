const resolvers = {
  ...
  Mutation: {
    ...
    addStudent: async (
      _,
      { first_name, last_name, primary_contact, secondary_contact },
      { dataSources }
    ) => {
      try {
        const student = await dataSources.studentAPI.addStudent(
          first_name,
          last_name,
          primary_contact,
          secondary_contact
    ...
    updateStudent: async (
      _,
      { student_id, first_name, last_name, primary_contact, secondary_contact },
      { dataSources }
    ) => {
      try {
        const student = await dataSources.studentAPI.updateStudent(
          student_id,
          first_name,
          last_name,
          primary_contact,
